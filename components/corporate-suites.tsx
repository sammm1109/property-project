...
export default function CorporateSuites() {
  ...
  return (
    <section id="corporate-suites">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 bg-[#371807] text-center">
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="grid text-white gap-5">
              ...
              <p className="text-xl font-medium">
                ...
                functionality, empowering businesses to thrive in Kuala Lumpur’s
                vibrant district. The 25-story tower has 106 units, with offices
                ranging from 1,093 sq.ft. to 9,769 sq.ft.
              </p>
